...
public interface OnDataBaseAction {
    ...
    @Query("UPDATE Task SET taskTitle = :taskTitle,rating= :rating, taskDescription = :taskDescription, date = :taskDate, " +
            "lastAlarm = :taskTime, event = :taskEvent WHERE taskId = :taskId")
    void updateAnExistingRow(int taskId, String taskTitle, int rating, String taskDescription, String taskDate, String taskTime,
                             float taskEvent);
}
